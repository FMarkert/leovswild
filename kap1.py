...
def chap1():
    ...
    global lifepoints  
    print("Du wachst an einem Sonntagnachmittag an einem wunderschönen sonnigen Frühlingstag auf und \nbetrachtest dich im Spiegel. \nDer Winter war lang und hart und du fasst den Entschluss, dich endlich wieder in Form zu bringen. \n")

    print("Starten möchtest du deine große Transformation mit einer Runde Joggen im Wald. \nDu wirfst dich in deinen Jogginganzug, machst dir Kopfhörer rein \nund verlässt das Haus in Richtung des nahegelegenen Waldes.\n")

    print("Die Sonne scheint durch die Baumkronen, Vögel zwitschern und die Luft ist frisch. \nAls du tiefer in den Wald eindringst, bemerkst du, dass sich die Umgebung immer dichter verändert.\n")

    print("Der Wald wird dichter und unheimlicher und du hörst seltsame Geräusche um dich herum. \nDu spürst, wie sich eine leichte Unruhe in dir ausbreitet. \nAber bevor du Zeit hast, darüber nachzudenken, entdeckst du am Wegrand plötzlich einen Fuchs.\n")

    print("Wie verhältst du dich?")
